...
const Register = () => {
 ...
 <div className="mb-6">
 <div className="flex items-center gap-2 mb-6 group pl-2">
 ...
 <p className="text-gray-500">Đăng ký để xác thực tài khoản của bạn ngay hôm nay</p>
 </div>
 ...
 <div>
 <div className="relative">
 <label className="sr-only">Tôi là...</label>
