...
const Wallet = () => {
 ...
 name="price"
 id="price"
 className=" focus:border-black block w-full pl-7 pr-12 sm:text-sm border-gray-300 rounded-md text-gray-900 h-10"
 placeholder="0.00"
 value={depositAmount}
 ...
 type="submit"
 disabled={processing}
 className="inline-flex justify-center items-center px-6 py-2 border border-transparent text-sm font-medium rounded-md text-indigo-700 bg-white hover:bg-gray-50 focus:outline-none -offset-gray-900 disabled:opacity-50"
 >
