                    ...
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div className="bg-white overflow-hidden shadow rounded-lg">
                            <div className="p-5">
                                ...
                                <div className="bg-gray-50 px-5 py-3 mt-5 -mx-5 -mb-5">
                                    <div className="text-sm">
                                        <a href="#" className="font-medium text-indigo-600 hover:text-indigo-500">Xem Phân Tích</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div className="px-4 py-4 sm:px-6 hover:bg-gray-50 transition-colors">
                                            <div className="flex items-center justify-between">
                                                ...
                                                <div className="flex flex-row items-center gap-3">
                                                    <span className={`px-2.5 py-0.5 inline-flex text-xs leading-5 font-semibold rounded-full ${job.status === 'COMPLETED' ? 'bg-green-100 text-green-800' :
